...
class PasswordResetLinkController extends Controller
{
    ...
    {
        try {
            Log::info('PasswordResetLinkController::create - Carregando view forgot-password', [
    ...
    public function store(Request $request): RedirectResponse
    {
        try {
            ...
            Log::info('PasswordResetLinkController::store - PASSO 1: Validação de e-mail concluída', [
                'email' => $request->email,
                'ip' => $request->ip(),
                'user_agent' => $request->userAgent(),
                'timestamp' => now()->toISOString()
