...
class BudgetApiController extends Controller
{
    ...
    public function approve( Budget $budget ): JsonResponse
    {
        ...
        try {
            $budget->budget_statuses_id = \App\Models\BudgetStatus::where( 'slug', 'aprovado' )->first()->id;
            $budget->save();
    ...
    public function reject( Request $request, Budget $budget ): JsonResponse
    {
        ...
        try {
            $budget->budget_statuses_id = \App\Models\BudgetStatus::where( 'slug', 'rejeitado' )->first()->id;
            $budget->save();
