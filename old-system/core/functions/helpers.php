...
function getDetailedErrorInfo(Throwable $e)
{
    $errorHandler = new \core\support\ErrorHandler();
...
function handleLastUpdateSession(string $key): bool
{
    ...
    $last_updated_session = (int) Session::get($key);
 ...
 */
function isValidTokenFormat($token): bool
{
