...
if ( !file_exists( $appFilters = APP_PATH . '/filters/twig.php' ) ) {
    throw new Exception( "Please create filters inside app/filters/twig.php file. It should return an array of Twig filters." );
}
