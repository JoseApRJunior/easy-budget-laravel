...
class Schedule extends Model
{
    ...
    /**
     * Cria uma nova instância de ScheduleEntity a partir dos dados fornecidos.
     *
     * @param array<string, mixed> $data Os dados para criar a entidade.
     * @return Entity A instância criada de ScheduleEntity.
     */
    ...
    /**
     * Busca o último token de agendamento por ID do serviço.
     *
     * @param int $service_id ID do serviço
     * @param int $tenant_id ID do tenant
     * @return object|EntityNotFound Objeto com dados do token ou EntityNotFound
     */
    public function getLastSchedulingTokenByServiceId(int $service_id, int $tenant_id): object
    {
        try {
