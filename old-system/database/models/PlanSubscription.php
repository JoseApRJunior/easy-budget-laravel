...
class PlanSubscription extends Model
{
    ...
    /**
     * Cria uma nova instância de PlanSubscriptionEntity a partir dos dados fornecidos.
     *
     * @param array<string, mixed> $data Os dados para criar a entidade.
     * @return Entity A instância criada de PlanSubscriptionEntity.
     */
     ...
     * @return array<int, array<string, mixed>> Um array de objetos de assinatura com informações detalhadas.
     */
    ...
    /**
     * Busca todas as assinaturas de um provedor específico, com detalhes.
     *
     * @param int $providerId ID do provedor.
     * @return array<int, array<string, mixed>> Array de objetos de assinatura.
     */
