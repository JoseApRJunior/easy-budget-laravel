...
class User extends Model
{
    ...
    /**
     * Cria uma nova instância de UserEntity a partir dos dados fornecidos.
     *
     * @param array<string, mixed> $data Os dados para criar a entidade.
     * @return Entity A instância criada de UserEntity.
     */
    ...
    /**
     * Busca os papéis (roles) de um usuário.
     *
     * @param int $user_id ID do usuário
     * @param int $tenant_id ID do tenant
     * @return array<int, string> Array com os nomes dos papéis do usuário
     */
     ...
     * @param int $user_id ID do usuário
     * @param int $tenant_id ID do tenant
     * @return array<int, string> Array com os nomes das permissões do usuário
     */
