...
class Activity extends Model
{
    ...
    /**
     * Busca as atividades recentes de um tenant.
     *
     * @param int $tenantId ID do tenant
     * @param int $limit Limite de resultados
     * @return array<int, array<string, mixed>> Array com as atividades recentes
     */
    public function getRecentActivities( int $tenantId, int $limit = 5 ): array
    {
