...
class Product extends Model
{
    ...
    /**
     * Cria uma nova instância de ProductEntity a partir dos dados fornecidos.
     *
     * @param array<string, mixed> $data Os dados para criar a entidade.
     * @return Entity A instância criada de ProductEntity.
     */
     ...
     * @return array<int, Entity>|Entity Array com todos os produtos ou uma única entidade
     */
    public function getAllProducts(int $tenant_id): array|Entity
    {
     ...
     *
     * @param int $tenant_id ID do tenant
     * @return array<int, Entity>|Entity Array com produtos ativos ou uma única entidade
     */
    public function getAllProductsActive(int $tenant_id): array|Entity
    {
    ...
    /**
     * Busca produtos com inventário por código.
     *
     * @param string $code Código do produto
     * @param int $tenant_id ID do tenant
     * @return array<string, mixed> Dados do produto com inventário
     */
    ...
    /**
     * Busca produtos por filtros para relatório.
     *
     * @param array<string, mixed> $data Dados dos filtros
     * @param int $tenant_id ID do tenant
     * @return array<int, array<string, mixed>> Array com produtos filtrados
     */
