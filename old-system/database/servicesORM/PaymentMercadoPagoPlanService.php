...
class PaymentMercadoPagoPlanService implements ServiceInterface
{
    /**
     * Summary of table
     * @var string
            ...
            return $this->connection->transactional( function () use ($webhookPaymentData) {
                ...
                if ( !$lastPayment instanceof EntityNotFound ) {
                    ...
                    foreach ( $payments as $payment ) {
                        ...
                        // Verificar se $payment é null antes de acessar propriedades
                        if ( $payment === null ) {
                            continue;
                        }
                ...
                // Verificar se $existingPayment é null antes de acessar propriedades
    ...
    {
        throw new RuntimeException( 'Método getByIdAndTenantId não implementado para PaymentMercadoPagoPlanService' );
    }
    ...
    {
        throw new RuntimeException( 'Método listByTenantId não implementado para PaymentMercadoPagoPlanService' );
    }
    ...
    {
        throw new RuntimeException( 'Método createByTenantId não implementado para PaymentMercadoPagoPlanService' );
    }
    ...
    {
        throw new RuntimeException( 'Método deleteByIdAndTenantId não implementado para PaymentMercadoPagoPlanService' );
    }
    ...
    {
        throw new RuntimeException( 'Método validate não implementado para PaymentMercadoPagoPlanService' );
    }
