...
/**
 * Middleware de Prestador
 *
 * Gerencia autenticação, validação de planos e sessões
 * para prestadores de serviços no sistema Easy Budget.
 */
class Provider implements MiddlewareInterface
{
    ...
    /**
     * Executa as verificações de prestador e validação de planos
     *
    ...
    private function loadProviderData(): mixed
    {
    ...
    private function validatePlan( mixed $provider ): ?Redirect
    {
    ...
    private function cacheProviderData( mixed $provider, mixed $plan ): void
    {
    ...
    private function handleExpiredPlan( mixed $checkPlan ): ?Redirect
    {
