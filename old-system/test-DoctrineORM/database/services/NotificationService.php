...
class NotificationService
{
     ...
     * @param array<string, mixed> $pdf Array contendo 'content' e 'fileName' do PDF.
     ...
     *
     * @param object $authenticated Objeto com os dados do usuário autenticado.
     * @param array<string, mixed> $paymentData Array contendo os dados do pagamento.
     * @return array<string, mixed> Retorna um array com o status e a mensagem da operação.
     */
     ...
     * @param object $customer Objeto com os dados do cliente.
     * @param object $authenticated Objeto com os dados do usuário autenticado.
     * @param array<string, mixed> $invoiceData Array contendo os dados da fatura.
     * @param array<string, mixed> $payment Array contendo os dados do pagamento.
     * @return array<string, mixed> Retorna um array com o status e a mensagem da operação.
     */
     ...
     */
    public function sendAccountConfirmation( string $email, string $firstName, string $token ): bool
    {
     ...
     * @return bool Resultado do envio.
     */
    public function sendResendConfirmation( string $email, string $firstName, string $token ): bool
    {
        $confirmationLink = env( 'APP_URL' ) . '/confirm-account?token=' . $token;
     ...
     * @return bool Resultado do envio.
     */
    public function sendPasswordReset( string $email, string $firstName, string $newPassword ): bool
    {
     ...
     * @return bool Resultado do envio.
     */
    public function sendPasswordChanged( string $email, string $firstName, string $blockToken ): bool
    {
