...
class LogController extends AbstractController
{
    ...
    public function index(): Response
    {
        ...
        if ( file_exists( $logFilePath ) ) {
            ...
            if ( $fileContent !== false ) {
                ...
                if ( is_array( $logEntries ) ) {  // <-- add this check
        ...
        if ( is_array( $availableLogs ) ) {  // <-- add this check
     ...
     * @return array<string, string|bool> The parsed log data.
     */
