// budget.js - Versão adaptada para usar TablePaginator
document.addEventListener("DOMContentLoaded", function () {
   ...
   function formatBudgetRow(budget) {
      ...
      <tr>
         ...
         <td style="width: 10%; text-align: left;">${formatDate(
            budget.created_at
         )}</td>
         <td style="width: 10%; text-align: left;">${formatDate(
            budget.due_date
         )}</td>
         <td style="width: 10%; text-align: right;">${formatMoney(
            budget.total
         )}</td>
         ...
         <td class="text-end px-4 align-middle">
            <div class="btn-group gap-1">
               <a href="/provider/budgets/${
                  budget.code
               }/services/create" class="btn btn-sm btn-outline-success"
                  data-bs-toggle="tooltip" title="Novo Serviço">
                  <i class="bi bi-plus-lg"></i>
               </a>
               <a href="/provider/budgets/show/${
                  budget.code
               }" class="btn btn-sm btn-outline-warning"
                  data-bs-toggle="tooltip" title="Visualizar">
                  <i class="bi bi-eye"></i>
               </a>
               <a href="/provider/budgets/update/${
                  budget.code
