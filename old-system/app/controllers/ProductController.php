...
class ProductController extends AbstractController
{
    ...
    public function update($code): Response
    {
    ...
    public function update_store(): Response
    {
        try {
            ...
            if ($product instanceof EntityNotFound) {
    ...
    public function deactivate($code): Response
    {
        $code = $this->sanitize->sanitizeParamValue($code, 'string');
    ...
    public function activate($code): Response
    {
        $code = $this->sanitize->sanitizeParamValue($code, 'string');
