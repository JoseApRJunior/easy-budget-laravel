...
use app\database\services\ServiceService;
...
class ServiceController extends AbstractController
{
    ...
    public function create($code = null): Response
    {
    ...
    public function show($code): Response
    {
        ...
        return new Response($this->twig->env->render('pages/service/show.twig', [
            ...
            'budget' => (array) $budget,
            'invoice' => ($invoice instanceof EntityNotFound) ? null : $invoice,
    ...
    public function view_service_status($code, $token): Response
    {
        $code = $this->sanitize->sanitizeParamValue($code, 'string');
