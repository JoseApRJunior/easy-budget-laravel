...
class CustomerFormRequest extends AbstractFormRequest
{
    protected function execute(): bool
    {
        ...
        $validator->addRule(new Key('email_business', new AllOf(
            v::email()->setTemplate('Informe um e-mail válido'),
            v::notEmpty()->setTemplate('O e-mail comercial é obrigatório'),
        )));
