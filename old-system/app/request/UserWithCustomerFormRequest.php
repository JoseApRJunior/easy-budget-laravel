...
class UserWithCustomerFormRequest extends AbstractFormRequest
{
    protected function execute(): bool
    {
        ...
        $validator->addRule( new Key( 'business_phone', v::notEmpty()->setTemplate( 'O telefone comercial é obrigatório' ) ) );
        ...
        $validator->addRule( new Key( 'area_of_activity', v::notEmpty()->setTemplate( 'A área de atuação é obrigatória' ) ) );
        $validator->addRule( new Key( 'profession', v::notEmpty()->setTemplate( 'A profissão é obrigatória' ) ) );
        ...
        $validator->addRule( new Key( 'number', v::notEmpty()->setTemplate( 'O número é obrigatório' ) ) );
