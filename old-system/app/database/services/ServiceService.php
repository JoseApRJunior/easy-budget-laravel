...
class ServiceService
{
    ...
    public function handleStatusScheduled( array $data )
    {
        try {
            return $this->connection->transactional( function () use ($data) {
                $result                       = [];
    ...
    public function handleTokenUpdateScheduledStatus( string $code, UserConfirmationTokenEntity $userConfirmationTokenEntity, object $authenticated )
    {
        if ( $this->authenticated === null ) {
            $this->authenticated = $authenticated;
        }
