...
use app\database\entities\CustomerEntity;
...
class CustomerService
{
     ...
     *
     * @param array $data Um array associativo contendo os detalhes do registro do usuário.
     * @return array Retorna true ou o ID do usuário em caso de sucesso, ou false em caso de falha.
     */
    ...
    public function checkRelationships($tableId, $tenantId)
    {
        try {
