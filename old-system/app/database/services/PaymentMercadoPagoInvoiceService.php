...
class PaymentMercadoPagoInvoiceService
{
    ...
    /**
     * Creates or updates a payment record for an invoice.
     * This ensures idempotency for webhook notifications.
     *
     * @param array $webhookPaymentData Data from Mercado Pago API.
     ...
     * @param int $tenantId
     * @return array O link de pagamento (init_point).
     */
    public function createMercadoPagoPreference( string $invoiceCode, int $tenantId )
    {
    ...
    protected function authenticate( $accessTokenEcrypted ): void
    {
