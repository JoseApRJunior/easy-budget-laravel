...
class PlanService
{
            ...
            return $this->connection->transactional(function () use ($planSelected) {
                ...
                return [
                    ...
                    'data' => [
                        ...
                        'currentPlanSubscriptionPending' => $currentSubscriptionPending ?? null,
                    ],
                ];
    ...
    public function updateStatusCancelled($tenant_id, $provider_id, $last_planSubscription_id)
    {
        try {
    ...
    public function createSubscription($planSlug): array
    {
