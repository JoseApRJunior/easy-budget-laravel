...
class PdfService
{
    ...
    public function generateBudgetPdf( object $authenticated, object $customer, object $budget, array $services, array $service_items, array $latest_schedules, string $verificationHash )
    {
    ...
    public function generateServicePdf( object $authenticated, object $customer, object $budget, object $service, array $serviceItems, object $latest_schedule, string $verificationHash )
    {
    ...
    public function generateInvoicePdf( object $authenticated, object $invoice )
    {
        $date = new \DateTime();
