...
-- User Confirmation Tokens (depende de tenants, customers)
CREATE TABLE
  IF NOT EXISTS `user_confirmation_tokens` (
    `id` int (11) NOT NULL AUTO_INCREMENT,
    `tenant_id` int (11) NOT NULL,
    ...
    CONSTRAINT `fk_user_confirmation_tokens_tenant` FOREIGN KEY (`tenant_id`) REFERENCES `tenants` (`id`),
    CONSTRAINT `fk_user_confirmation_tokens_customer` FOREIGN KEY (`customer_id`) REFERENCES `customers` (`id`)
  ) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;
...
-- Inserindo dados para a tabela easybudget.addresses
INSERT INTO
  `addresses` (
    `id`,
    `tenant_id`,
...
-- Inserindo dados para a tabela easybudget.areas_of_activity
INSERT INTO
  `areas_of_activity` (
    `id`,
    `slug`,
...
-- Inserindo dados para a tabela easybudget.budgets
INSERT INTO
  `budgets` (
    `id`,
    `tenant_id`,
...
-- Inserindo dados para a tabela easybudget.budget_statuses
INSERT INTO
  `budget_statuses` (
    `id`,
    `slug`,
...
-- Inserindo dados para a tabela easybudget.categories
INSERT INTO
...
-- Inserindo dados para a tabela easybudget.common_datas
INSERT INTO
  `common_datas` (
    `id`,
    `tenant_id`,
...
-- Inserindo dados para a tabela easybudget.contacts
INSERT INTO
  `contacts` (
    `id`,
    `tenant_id`,
...
-- Inserindo dados para a tabela easybudget.customers
INSERT INTO
  `customers` (
    `id`,
    `tenant_id`,
...
-- Inserindo dados para a tabela easybudget.inventory_movements
INSERT INTO
  `inventory_movements` (
    `id`,
    `tenant_id`,
...
-- Inserindo dados para a tabela easybudget.permissions
INSERT INTO
  `permissions` (
    `id`,
    `name`,
...
-- Inserindo dados para a tabela easybudget.plans
INSERT INTO
  `plans` (
    `id`,
    `name`,
...
-- Inserindo dados para a tabela easybudget.plan_subscriptions
INSERT INTO
  `plan_subscriptions` (
    `id`,
    `provider_id`,
...
-- Inserindo dados para a tabela easybudget.products
INSERT INTO
  `products` (
    `id`,
    `tenant_id`,
...
-- Inserindo dados para a tabela easybudget.product_inventory
INSERT INTO
  `product_inventory` (
    `id`,
    `tenant_id`,
...
-- Inserindo dados para a tabela easybudget.professions
INSERT INTO
  `professions` (
    `id`,
    `slug`,
...
-- Inserindo dados para a tabela easybudget.providers
INSERT INTO
  `providers` (
    `id`,
    `tenant_id`,
...
-- Inserindo dados para a tabela easybudget.resources
INSERT INTO
  `resources` (
    `id`,
    `name`,
...
-- Inserindo dados para a tabela easybudget.roles
INSERT INTO
  `roles` (
    `id`,
    `name`,
...
-- Inserindo dados para a tabela easybudget.role_permissions
INSERT INTO
...
-- Inserindo dados para a tabela easybudget.services
INSERT INTO
  `services` (
    `id`,
    `tenant_id`,
...
-- Inserindo dados para a tabela easybudget.service_items
INSERT INTO
  `service_items` (
    `id`,
    `tenant_id`,
...
-- Inserindo dados para a tabela easybudget.service_statuses
INSERT INTO
  `service_statuses` (
    `id`,
    `slug`,
...
-- Inserindo dados para a tabela easybudget.tenants
INSERT INTO
...
-- Inserindo dados para a tabela easybudget.units
INSERT INTO
  `units` (
    `id`,
    `slug`,
...
-- Inserindo dados para a tabela easybudget.users
INSERT INTO
  `users` (
    `id`,
    `tenant_id`,
...
-- Inserindo dados para a tabela easybudget.user_confirmation_tokens
INSERT INTO
...
-- Inserindo dados para a tabela easybudget.user_roles
INSERT INTO
  `user_roles` (
    `user_id`,
    `role_id`,
