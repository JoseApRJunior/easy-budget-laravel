...
class Service extends Model
{
    ...
    public function getLastCode(int $budget_id, int $tenant_id)
    {
    ...
    public function getServiceFullById(int $id, int $tenant_id)
    {
        try {
    ...
    public function getAllServiceFullByIdBudget(int $budget_id, int $tenant_id): array|bool
    {
        try {
    ...
    public function getAllServices(int $tenant_id)
    {
        try {
    ...
    public function getAllServicesNotCompleted(int $tenant_id)
    {
        try {
