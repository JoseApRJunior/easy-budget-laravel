...
class PaymentMercadoPago extends Model
{
    ...
    {
        return PaymentMercadoPagoEntity::create( $data );
    }

    public function getPaymentId( string $payment_id, int $tenant_id, int $provider_id ): PaymentMercadoPagoEntity|Entity
    {
        try {
            return $this->findBy( [ 
    ...
    public function getPaymentByPlanSubscription( string $provider_id, int $tenant_id, int $plan_subscription_id ): PaymentMercadoPagoEntity|array|Entity
    {
        try {
            return $this->findBy( [ 
                'provider_id'          => $provider_id,
