                ...
                <div class="card border-0 shadow-sm">
                    <div class="card-body p-4">
                        ...
                        <div class="row g-4 mb-4">
                            ...
                            @php
                                $statusEnum = $budget->status instanceof \App\Enums\BudgetStatus ? $budget->status : \App\Enums\BudgetStatus::tryFrom($budget->status);
                            @endphp
                ...
                @forelse( $budget->services as $service )
                    <div class="card mb-4 border-0 shadow-sm">
                        <div class="card-header p-3 d-flex justify-content-between align-items-center">
                            ...
                            @php
                                $serviceStatus = $service->status instanceof \App\Enums\ServiceStatus ? $service->status : \App\Enums\ServiceStatus::tryFrom($service->status);
                            @endphp
                            <span class="badge"
