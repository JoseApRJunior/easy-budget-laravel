...
/**
 * TESTE DE VALIDAÇÃO DE RELACIONAMENTOS DOS MODELOS
 *
 * Script para validar relacionamentos e funcionalidades dos modelos principais
 * do sistema Easy Budget Laravel.
 *
 * EXECUÇÃO:
 * - Via artisan tinker: require 'test_relationships_validation.php'
 * - Via comando artisan: php artisan test:relationships
 *
 * @author Kilo Code
 * @version 1.0.0
 */
...
function runRelationshipTests(): array
{
...
if ( isset( $argv ) && strpos( $argv[ 0 ], 'test_relationships_validation.php' ) !== false ) {
