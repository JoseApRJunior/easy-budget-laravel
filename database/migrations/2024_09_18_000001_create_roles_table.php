...
/**
 * Migração atualizada para criação da tabela 'roles' como global (sem tenant_id).
 *
 ...
 * - Adicionado declare(strict_types=1) para tipagem rigorosa em conformidade com PSR-12.
...
{
    /**
     * Executa a migração para criar a tabela roles.
     */
    ...
    /**
     * Reverte a migração removendo a tabela roles.
     */
