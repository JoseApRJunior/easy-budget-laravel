...
- **Input de Data:** `type="date"` (nativo do navegador para melhor UX mobile) ou `type="text"` com máscara se necessário. Sempre definir `min="{{ date('Y-m-d') }}"` para campos de vencimento/prazo.
