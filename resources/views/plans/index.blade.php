...
@section( 'title', 'Planos - Easy Budget' )
                    ...
                    <form method="GET" class="row g-3">
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" id="search" name="search"
                                value="{{ request( 'search' ) }}" placeholder="Nome do plano...">
                        </div>
                        <div class="col-md-3">
                ...
                <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group" role="group">
                                                    <a href="{{ route( 'plans.show', $plan ) }}" class="btn btn-sm btn-outline-info"
                                                    ...
                                                    <a href="{{ route( 'plans.edit', $plan ) }}"
                                                        ...
                                                        @if( $plan->status === 'active' )
                                                            <button type="button" class="btn btn-sm btn-outline-warning btn-delete"
                                                                ...
                                                                data-name="{{ $plan->name }}" data-bs-toggle="tooltip"
                                                                title="Desativar">
                                                                <i class="bi bi-pause"></i>
                                                            </button>
                                                        @else
                                                            <form method="POST" action="{{ route( 'plans.activate', $plan ) }}"
                                                                class="d-inline">
                                                                @csrf
                                                                @method( 'PATCH' )
                    ...
                    @else
                        <div class="text-center py-5">
                            ...
                            <h4 class="mt-3 text-muted">Nenhum plano encontrado</h4>
                            <p class="text-muted">Comece criando seu primeiro plano para gerenciar orçamentos.</p>
                            <a href="{{ route( 'plans.create' ) }}" class="btn btn-primary">
                                <i class="bi bi-plus-circle me-2"></i>
