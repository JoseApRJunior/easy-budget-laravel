...
<head>
    ...
    <title>Easy Budget - Serviço em Andamento</title>
    <style>
        body {
...
<body>
    <div class='container'>
        <div class='header'>
            <h1>Seu Serviço está em Andamento!</h1>
        </div>
        <div class='content'>
            <p>Olá, {{ $emailData[ 'first_name' ] }}.</p>
            <p>Ótima notícia! Começamos a trabalhar no seu serviço <strong>#{{ $emailData[ 'service_code' ] }}</strong>.
            </p>
            <p>Você pode acompanhar o progresso e visualizar os detalhes completos no link abaixo.</p>


            <p>Acesse o serviço para mais detalhes:</p>
            <a href="{{ $emailData[ 'link' ] }}" class="btn">Acompanhar Serviço</a>
