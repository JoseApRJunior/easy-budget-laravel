...
<head>
  ...
  <title>Easy Budget - Serviço Parcialmente Concluído</title>
  <style>
    body {
...
<body>
  <div class='container'>
    <div class='header'>
      <h1>Serviço Parcialmente Concluído</h1>
    </div>
    <div class='content'>
      <p>Olá, {{ $emailData[ 'first_name' ] }}.</p>
      <p>Gostaríamos de informar que o serviço <strong>#{{ $emailData[ 'service_code' ] }}</strong> foi concluído de forma
        parcial.</p>
      <p>O trabalho foi finalizado neste estágio. O valor final a ser faturado será calculado com base no que foi
        efetivamente realizado.</p>


      <p>Para mais detalhes, acesse o link abaixo.</p>
      <a href="{{ $emailData[ 'link' ] }}" class="btn">Ver Detalhes do Serviço</a>
