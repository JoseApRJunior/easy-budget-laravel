...
<head>
    ...
    <title>Easy Budget - Serviço {{ $emailData[ 'service_code' ] }} - {{ $emailData[ 'service_status_name' ] }}</title>
    <style>
        body {
...
<body>
    <div class='container'>
        <div class='header'>
            <h1>Easy Budget - Atualização de Serviço</h1>
        </div>
        <div class='content'>
            <p>Olá, {{ $emailData[ 'first_name' ] }}.</p>

            <p>Seu serviço <strong>#{{ $emailData[ 'service_code' ] }}</strong> foi atualizado para o status:
                <strong>{{ $emailData[ 'service_status_name' ] }}</strong>.
            </p>
            <p>Você pode visualizar os detalhes completos do serviço no link abaixo.</p>
