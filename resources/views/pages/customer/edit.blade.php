    ...
    <form action="{{ route('provider.customers.update', $customer) }}" method="POST" id="customerForm">
        ...
        <div class="row g-4">
                        ...
                        <div id="pf_fields">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('cpf') is-invalid @enderror"
                                    id="cpf" name="cpf"
                                    value="{{ format_cpf(old('cpf', $customer->commonData?->cpf)) }}">
                                @error('cpf')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div id="pj_fields">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('cnpj') is-invalid @enderror"
                                    id="cnpj" name="cnpj"
                                    value="{{ format_cnpj(old('cnpj', $customer->commonData?->cnpj)) }}" data-mask="00.000.000/0000-00">
                                @error('cnpj')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
            ...
            <div class="d-flex justify-content-between mt-4">
                ...
                <x-ui.button type="submit" variant="primary" icon="check-circle" label="Atualizar" />
            </div>
        </form>
</x-layout.page-container>
@endsection
