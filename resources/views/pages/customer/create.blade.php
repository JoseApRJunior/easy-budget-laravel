        ...
        <div class="row g-4">
            ...
            <div class="col-lg-6">
                <div class="card border-0 shadow-sm h-100">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            <label for="first_name" class="text-uppercase small fw-bold text-muted mb-2">Nome <span class="text-danger">*</span></label>
                        ...
                        <div class="mb-3">
                            <label for="last_name" class="text-uppercase small fw-bold text-muted mb-2">Sobrenome <span class="text-danger">*</span></label>
                        ...
                        <div class="mb-3">
                            <label for="email_personal" class="text-uppercase small fw-bold text-muted mb-2">Email Pessoal <span class="text-danger">*</span></label>
                        ...
                        <div class="mb-3">
                            <label for="phone_personal" class="text-uppercase small fw-bold text-muted mb-2">Telefone Pessoal <span class="text-danger">*</span></label>
            ...
            <div class="col-lg-6">
                <div class="card border-0 shadow-sm h-100">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            <label for="person_type" class="text-uppercase small fw-bold text-muted mb-2">Tipo de Pessoa <span class="text-danger">*</span></label>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="cep" class="text-uppercase small fw-bold text-muted mb-2">CEP <span class="text-danger">*</span></label>
                        ...
                        <div class="mb-3">
                            <label for="address" class="text-uppercase small fw-bold text-muted mb-2">Endereço <span class="text-danger">*</span></label>
                        ...
                        <div class="mb-3">
                            <label for="neighborhood" class="text-uppercase small fw-bold text-muted mb-2">Bairro <span class="text-danger">*</span></label>
                        ...
                        <div class="row">
                            <div class="col-md-8 mb-3">
                                <label for="city" class="text-uppercase small fw-bold text-muted mb-2">Cidade <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-4 mb-3">
                                <label for="state" class="text-uppercase small fw-bold text-muted mb-2">Estado <span class="text-danger">*</span></label>
