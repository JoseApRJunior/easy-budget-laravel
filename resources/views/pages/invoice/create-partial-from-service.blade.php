        ...
        <div class="card-body p-4">
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-6 text-md-end">
                    ...
                    <p><strong>Data de Vencimento:</strong> {{ \Carbon\Carbon::parse($invoiceData['due_date'])->format('d/m/Y') }}</p>
            ...
            <form action="{{ route('provider.invoices.store.manual-from-service', $serviceCode) }}" method="POST" id="partialInvoiceForm">
                @csrf
                    ...
                    <table class="table table-bordered" id="itemsTable">
                        ...
                        <tbody>
                            ...
                            <tr data-item-id="{{ $item->id }}">
                                ...
                                <td class="text-end">
                                    R$ <span class="unit-value">{{ number_format($item->unit_value, 2, ',', '.') }}</span>
                                    <input type="hidden" name="items[{{ $index }}][unit_value]" value="{{ $item->unit_value }}">
                                </td>
                                <td class="text-end">
                                    R$ <span class="total-item">{{ number_format($item->total, 2, ',', '.') }}</span>
                                </td>
                                <td class="text-end">
    ...
    function calculateTotals() {
        ...
        itemCheckboxes.forEach((checkbox, index) => {
            if (checkbox.checked) {
                ...
                const partialTotalElement = document.querySelector(`.partial-total[data-index="${index}"]`);
