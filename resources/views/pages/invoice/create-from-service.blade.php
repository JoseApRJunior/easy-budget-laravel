    ...
    <div class="card border-0 shadow-sm">
        <div class="card-body p-4">
            ...
            <div class="alert alert-warning">
                ...
                <strong>Fatura Parcial:</strong> {{ $invoiceData['notes'] ?? 'Esta fatura corresponde à conclusão parcial do serviço.' }}
            </div>
            @endif
                        ...
                        <table class="table">
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-end">R$ {{ number_format($invoiceData['subtotal'], 2, ',', '.') }}</td>
                                </tr>
                                <tr>
                                    <th>Desconto:</th>
                                    <td class="text-end text-danger">- R$ {{ number_format($invoiceData['discount'], 2, ',', '.') }}</td>
                                </tr>
                                <tr class="h5">
                                    <th>Total:</th>
                                    <td class="text-end text-success">R$ {{ number_format($invoiceData['total'], 2, ',', '.') }}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
