            ...
            <div class="card-header bg-transparent border-0 d-flex justify-content-between align-items-center">
                ...
                <div class="btn-group">
                    <a href="{{ route('provider.inventory.export', ['type' => 'pdf', 'report_type' => $type ?? 'summary']) }}"
                        class="btn btn-sm btn-outline-secondary"><i class="bi bi-file-earmark-pdf me-2"></i>PDF</a>
                    <a href="{{ route('provider.inventory.export', ['type' => 'xlsx', 'report_type' => $type ?? 'summary']) }}"
                        class="btn btn-sm btn-outline-secondary"><i class="bi bi-file-earmark-excel me-2"></i>Excel</a>
                    <a href="{{ route('provider.inventory.export', ['type' => 'csv', 'report_type' => $type ?? 'summary']) }}"
                        class="btn btn-sm btn-outline-secondary"><i class="bi bi-filetype-csv me-2"></i>CSV</a>
                </div>
            </div>
            <div class="card-body">
