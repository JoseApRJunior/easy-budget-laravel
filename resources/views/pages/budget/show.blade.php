        ...
        <div class="card-body p-4">
            <div class="row g-4">
                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        <strong>CNPJ:</strong> {{ \App\Helpers\DocumentHelper::formatCnpj($budget->customer->commonData->cnpj) }}
                    </div>
                    @elseif($budget->customer->commonData->cpf)
                    <div class="mb-3">
                        <strong>CPF:</strong> {{ \App\Helpers\DocumentHelper::formatCpf($budget->customer->commonData->cpf) }}
                    </div>
                    @endif
                    @endif
