            ...
            <div class="card-body p-4">
                            ...
                            <div class="col-md-4">
                                <div class="card bg-light">
                                    <div class="card-body text-center">
                                        <h6 class="card-title">Subtotal (Serviços)</h6>
                                        <h4 class="text-dark">R$ {{ number_format($servicesSubtotal, 2, ',', '.') }}</h4>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="card bg-light">
                                    <div class="card-body text-center">
                                        <h6 class="card-title">Desconto do Orçamento</h6>
                                        <h4 class="text-warning">R$ {{ number_format($budget->discount, 2, ',', '.') }}
                                        </h4>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="d-flex justify-content-between mt-4 pt-4 border-top">
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <a href="{{ route('provider.budgets.print', $budget->code) }}" class="btn btn-outline-info px-4"
                            target="_blank">
                            <i class="bi bi-printer me-2"></i>Imprimir
                        </a>
                        <a href="{{ route('provider.budgets.print', ['budget' => $budget->code, 'pdf' => true]) }}"
                            class="btn btn-outline-danger px-4" target="_blank">
                            ...
                            <tbody>
                                @foreach ($budget->services as $service)
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge"
                                                style="background-color: {{ $service->color }}">{{ $service->name }}</span>
                                        </td>
                                        ...
                                        <td class="text-end px-4">
                                            <div class="btn-group">
                                                <a href="{{ route('provider.services.show', $service->code) }}"
                                                    class="btn btn-sm btn-outline-secondary" title="Ver Serviço">
                                                    <i class="bi bi-eye"></i>
                                                </a>
                                                <a href="{{ route('provider.services.edit', $service->code) }}"
                                                    class="btn btn-sm btn-outline-primary" title="Editar Serviço">
