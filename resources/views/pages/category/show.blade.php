        ...
        <div class="card-body p-4">
            <div class="row g-4">
                ...
                <div class="col-md-3">
                    <div class="d-flex flex-column">
                        ...
                        <h5 class="mb-0">{{ $category->name }} @if($category->tenant_id === null)<span class="badge bg-secondary ms-2">Sistema</span>@else<span class="badge bg-primary ms-2">Pessoal</span>@endif</h5>
                    </div>
                </div>
            ...
            <div class="mt-4 d-flex justify-content-between">
                ...
                <div>
                    ...
                    @php($isAdmin = true)
                    @endrole
                    @if(($isAdmin && $isGlobal) || (!$isAdmin && !$isGlobal))
