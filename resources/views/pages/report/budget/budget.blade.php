...
@section( 'content' )
    <div class="container-fluid py-1">
                    ...
                    <div class="col-md-2" style="position: relative;">
                        <div class="form-floating">
                            <input type="date" class="form-control" id="start_date" name="start_date"
                                placeholder="Data Inicial" pattern="\d{4}-\d{2}-\d{2}"
                    ...
                    <div class="col-md-2">
                        <div class="form-floating position-relative">
                            <input type="text" class="form-control" id="customer_name" name="customer_name"
                                placeholder="Digite nome, CPF ou CNPJ" value="{{ $filters[ 'customer_name' ] ?? '' }}"
                                autocomplete="off" data-bs-toggle="tooltip" data-bs-placement="top"
                                title="Busque por nome, CPF ou CNPJ do cliente">
                    ...
                    <div class="col-md-2">
                        <div class="form-floating">
                            <select class="form-select" id="status" name="status">
                                {!! budget_status_options( $filters[ 'status' ] ?? null ) !!}
                            </select>
                            <label for="status">
        ...
        {{-- Mensagem Inicial --}}
        <div id="initial-message" class="card border-0 shadow-sm text-center py-1 @if( isset( $budgets ) ) d-none @endif">
            <div class="card-body">
                ...
                <div class="card-header bg-transparent border-0">
                    <div class="d-flex justify-content-between align-items-center">
                        <span id="results-count" class="text-muted">
                            @if( isset( $budgets ) )
                                Mostrando {{ count( $budgets ) }} resultados
                            @endif
                        </span>
                        <div class="btn-group">
