    ...
    <div class="container-fluid py-1">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1 class="h3 mb-0 text-gray-800">
                <i class="bi bi-tools me-2"></i>Relatório de Serviços
            </h1>
                ...
                <form id="filter-form" class="row g-3">
                    ...
                    <div class="col-md-4">
                        <div class="form-floating">
                            <input type="text" class="form-control" id="name" name="name" placeholder="Nome do Serviço"
                                value="{{ $filters[ 'name' ] ?? '' }}">
                            <label for="name">
                                <i class="bi bi-tools me-1"></i>Nome do Serviço
                            </label>
                        </div>
                    </div>
        ...
        {{-- Mensagem Inicial --}}
        <div id="initial-message" class="card border-0 shadow-sm text-center py-1 @if( isset( $services ) ) d-none @endif">
            <div class="card-body">
                ...
                <div class="card-header bg-transparent border-0">
                    <div class="d-flex justify-content-between align-items-center">
                        <span id="results-count" class="text-muted">
                            @if( isset( $services ) )
                                Mostrando {{ count( $services ) }} resultados
                            @endif
                        </span>
                        <div class="btn-group">
