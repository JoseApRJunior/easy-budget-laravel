                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="profession_id"
                                    class="form-select @error('profession_id') is-invalid @enderror" id="profession"
                                    required>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description"
                                    rows="3" maxlength="250" placeholder="Descreva sua experiência profissional...">{{ old('description', $provider->commonData?->description ?? '') }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="company_size"
                                        ...
                                        <option value="micro"
                                            {{ old('company_size', $provider->businessData?->company_size ?? '') == 'micro' ? 'selected' : '' }}>
                                            Microempresa</option>
                                        <option value="pequena"
                                            {{ old('company_size', $provider->businessData?->company_size ?? '') == 'pequena' ? 'selected' : '' }}>
                                            Pequena Empresa</option>
                                        <option value="media"
                                            {{ old('company_size', $provider->businessData?->company_size ?? '') == 'media' ? 'selected' : '' }}>
                                            Média Empresa</option>
                                        <option value="grande"
                                            {{ old('company_size', $provider->businessData?->company_size ?? '') == 'grande' ? 'selected' : '' }}>
