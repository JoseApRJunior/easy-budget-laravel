    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="card hover-card mb-4">
                ...
                <div class="card-body">
                    <p class="lead">
                        Estamos aqui para ajudar com qualquer dúvida ou problema relacionado ao nosso sistema de orçamentos. Por
                    ...
                    <div class="accordion" id="faqAccordion">
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="faqCollapse2" class="accordion-collapse collapse" aria-labelledby="faqHeading2"
                                ...
                                <div class="accordion-body">
                                    <p class="mb-3">
                                        Na seção "Meus Orçamentos", você encontrará uma lista de todos os seus orçamentos com seus
                                        respectivos status:
                                    </p>
                                    ...
                                    <p class="mb-3">
                                        Você pode clicar em cada orçamento para ver mais detalhes e atualizações, incluindo:
                                    </p>
                                    <ul class="list-group">
                                        <li class="list-group-item">
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="faqCollapse3" class="accordion-collapse collapse" aria-labelledby="faqHeading3"
                                ...
                                <div class="accordion-body">
                                    <p class="mb-0">
                                        Acesse a seção "Relatórios" no menu principal. Lá você encontrará opções para gerar:
                                    </p>
                                    ...
                                    <p class="mt-3 mb-0">
                                        Você pode personalizar o período e os tipos de dados que deseja incluir em cada relatório.
                                    </p>
                                </div>
                            </div>
                        </div>
            ...
            <div id="contact" class="card hover-card mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('support.contact') }}" method="POST" class="needs-validation" novalidate>
                        @csrf
