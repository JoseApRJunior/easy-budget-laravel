...
@section('title', 'Sobre o Easy Budget')
        ...
        <div class="col-md-10">
            ...
            <div class="card hover-card mb-4">
                <div class="card-body">
                    ...
                    <p class="lead">
                        No Easy Budget, nossa missão é simplificar e otimizar o processo de orçamentação de serviços diversos,
                        conectando prestadores de serviços e clientes de forma eficiente e transparente. Oferecemos ferramentas
                        intuitivas para ajudar tanto pessoas físicas quanto jurídicas a gerenciar seus orçamentos e projetos com
                        facilidade.
                    </p>
                </div>
            </div>
                ...
                <div class="col-md-6">
                    <div class="card hover-card h-100">
                        <div class="card-body">
                            ...
                            <p>
                                Somos uma equipe de profissionais apaixonados por tecnologia e gestão de projetos. Fundada em 2024,
                                nossa plataforma tem crescido rapidamente, atendendo a uma ampla gama de setores e facilitando a conexão
                ...
                <div class="col-md-6">
                    <div class="card hover-card h-100">
                        <div class="card-body">
                            ...
                            <p>
                                Imaginamos um mercado de serviços mais eficiente e transparente, onde prestadores e clientes possam
                                colaborar de forma harmoniosa. Estamos comprometidos em continuar inovando e expandindo nossas
                                funcionalidades para atender às necessidades em constante evolução do mercado de serviços.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="card hover-card mb-4">
                <div class="card-body text-center">
                    ...
                    <p class="mb-4">
                        Queremos ouvir você! Se você tem alguma dúvida, sugestão ou deseja saber mais sobre como o Easy Budget pode
                        ajudar seu negócio, não hesite em nos contatar.
                    </p>
                    <a href="{{ url('/support') }}" class="btn btn-primary">
