                                    ...
                                    <tr>
                                        <td>
                                            <p class="mb-0">Referente ao serviço:
                                                <strong>{{ $invoice->service_code }}</strong></p>
                ...
                <div class="card border-0 shadow-sm">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            ...
                            <span
                                class="fw-semibold @if ( \Carbon\Carbon::parse( $invoice->due_date )->isPast() && $invoice->status_slug == 'pending' ) text-danger @endif">
                        ...
                        <div class="d-grid gap-2 mt-4">
                            @if ( $invoice->status_slug == 'PENDING' )
                                <a href="{{ url( '/invoices/pay/' . $invoice->public_hash ) }}" class="btn btn-primary btn-lg">
                            ...
                            @elseif ( $invoice->status_slug == 'OVERDUE' )
                                <a href="{{ url( '/invoices/pay/' . $invoice->public_hash ) }}" class="btn btn-danger btn-lg">
