...
<div class="container-fluid py-4">
  <div class="row">
    <div class="col-12">
      <h2 class="mb-4">
        <i class="bi bi-speedometer2 me-2"></i>{{ $page_title ?? 'Dashboard Executivo' }}
        ...
        <div class="col-md-3">
          <div class="card border-0 shadow-sm h-100">
            <div class="card-body text-center">
              ...
              <small class="text-{{ str_starts_with( $kpis[ 'growth_rate' ] ?? '+0%', '+' ) ? 'success' : 'danger' }}">
                <i
                  class="bi bi-arrow-{{ str_starts_with( $kpis[ 'growth_rate' ] ?? '+0%', '+' ) ? 'up' : 'down' }}"></i>
                {{ $kpis[ 'growth_rate' ] ?? '+0%' }} vs período anterior
              </small>
            </div>
          </div>
        </div>
          ...
          <div class="card border-0 shadow-sm h-100">
            <div class="card-body text-center">
              ...
              <small class="text-{{ ( $kpis[ 'success_rate' ] ?? 0 ) >= 95 ? 'success' : 'warning' }}">
                <i class="bi bi-{{ ( $kpis[ 'success_rate' ] ?? 0 ) >= 95 ? 'check' : 'exclamation-triangle' }}"></i>
        ...
        <div class="col-md-3">
          <div class="card border-0 shadow-sm h-100">
            <div class="card-body text-center">
              ...
              <small class="text-{{ ( $kpis[ 'active_middlewares' ] ?? 0 ) > 0 ? 'success' : 'warning' }}">
                <i
              ...
              <div class="row text-center">
                ...
                <div class="col-md-4">
                  <div class="p-3">
                    ...
                    <h6>Uptime</h6>
                    <span class="badge bg-success">{{ $system_status[ 'uptime' ] ?? 'N/A' }}</span>
                  </div>
                </div>
              </div>
            </div>
