                                ...
                                <form id="qrForm">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="text" name="text" rows="4"
                                            placeholder="Digite o texto ou URL que deseja codificar..." required></textarea>
                                    </div>
                                    <div class="form-group">
                ...
                <form id="budgetQrForm">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="url" class="form-control" id="budget_url" name="url"
                ...
                <form id="invoiceQrForm">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="url" class="form-control" id="invoice_url" name="url"
                                placeholder="https://..." required>
                        </div>
                    </div>
                    <div class="modal-footer">
