        ...
        <div class="row g-4 mb-4">
                ...
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body d-flex flex-column justify-content-between">
                        <div class="d-flex align-items-center mb-3">
                            <div class="avatar-circle bg-primary bg-gradient me-3"><i class="bi bi-calendar text-white"></i>
                            </div>
                            <div>
            ...
            <div class="col-md-3">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body d-flex flex-column justify-content-between">
                        <div class="d-flex align-items-center mb-3">
                            <div class="avatar-circle bg-info bg-gradient me-3"><i
                                    class="bi bi-calendar-date text-white"></i></div>
                            <div>
            ...
            <div class="col-md-3">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body d-flex flex-column justify-content-between">
                        <div class="d-flex align-items-center mb-3">
                            <div class="avatar-circle bg-secondary bg-gradient me-3"><i
                                    class="bi bi-graph-up-arrow text-white"></i></div>
                            <div>
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-3">
                            <div class="avatar-circle bg-warning bg-gradient me-3"><i
                                    class="bi bi-list-check text-white"></i></div>
                            <h6 class="text-muted mb-0">Resumo</h6>
                        </div>
                        <ul class="list-unstyled small text-muted mb-0">
                            <li class="mb-2"><i class="bi bi-hourglass-split text-warning me-2"></i>Pendentes:
                                {{ $pending }}</li>
                            <li class="mb-2"><i class="bi bi-calendar-check text-primary me-2"></i>Confirmados:
                                {{ $confirmed }}</li>
                            <li class="mb-2"><i class="bi bi-x-circle text-danger me-2"></i>Cancelados:
                                {{ $cancelled }}</li>
                            <li class="mb-2"><i class="bi bi-slash-circle text-secondary me-2"></i>No-show:
                                {{ $noShow }}</li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="col-lg-8">
                <div class="card border-0 shadow-sm">
                    <div class="card-header bg-transparent border-0 d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('provider.schedules.index') }}" class="btn btn-sm btn-outline-primary">Ver
                            Todos</a>
                    </div>
                    <div class="card-body">
                                    ...
                                    <tbody>
                                        @foreach ($recent as $sc)
                                            <tr>
                                                ...
                                                <td><span
                                                        class="badge bg-secondary">{{ ucfirst(str_replace('_', ' ', $sc->status)) }}</span>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
            ...
            <div class="col-lg-4">
                <div class="card border-0 shadow-sm mb-3">
                    ...
                    <div class="card-body">
                        <ul class="list-unstyled mb-0 small text-muted">
                            <li class="mb-2"><i class="bi bi-calendar-check text-primary me-2"></i>Confirme pendentes
                                para evitar no-shows.</li>
                            <li class="mb-2"><i class="bi bi-x-circle text-danger me-2"></i>Reagende cancelados quando
                                possível.</li>
                        </ul>
                    </div>
                </div>
                <div class="card border-0 shadow-sm">
                    ...
                    <div class="card-body d-grid gap-2">
                        <a href="{{ route('provider.schedules.create', ['service' => 0]) }}"
                            class="btn btn-sm btn-success"><i class="bi bi-plus-circle me-2"></i>Novo Agendamento</a>
                        <a href="{{ route('provider.schedules.index') }}" class="btn btn-sm btn-outline-primary"><i
                                class="bi bi-calendar3 me-2"></i>Listar Agendamentos</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            Object.keys(statusData).forEach(k => {
                ...
                if (s && s.count > 0) {
                    labels.push(k.replace('_', ' ').replace('-', ' '));
                    values.push(s.count);
            ...
            if (values.length === 0) {
                ...
                if (c) {
                    c.innerHTML = '<p class="text-muted text-center mb-0 small">Nenhum agendamento cadastrado</p>';
                }
                return;
            }
