    ...
    <x-layout.grid-row>
        <div class="col-12">
            <x-ui.card>
                <x-layout.grid-row>
                    <div class="col-md-6">
                        <h5 class=" fw-bold mb-3 border-bottom pb-2">Informações do Agendamento</h5>
                    ...
                    <div class="col-md-6">
                        <h5 class="fw-bold mb-3 border-bottom pb-2">Informações do Serviço</h5>
                        <div class="table-responsive">
                            <table class="table table-hover">
                                <tr>
                                    <th class="w-50 text-muted small text-uppercase">Código</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge bg-{{ $schedule->service->status->color() }}">
