                ...
                <div class="card-header py-3 d-flex justify-content-between align-items-center">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="#" data-period="3months">Últimos 3 meses</a></li>
                            <li><a class="dropdown-item" href="#" data-period="6months">Últimos 6 meses</a></li>
                            <li><a class="dropdown-item" href="#" data-period="12months">Últimos 12 meses</a></li>
                        </ul>
                    </div>
                </div>
                <div class="card-body">
