                ...
                <div class="card-header bg-white border-0 py-3">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div>
                            ...
                            @if( $statusEnum )
                            <span class="badge fs-6 px-3 py-2" style="background-color: {{ $statusEnum->getColor() }}">
                ...
                <div class="card-body">
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-2">
                                <strong>Total:</strong>
                                <span class="text-success fs-5">R$ {{ number_format( $service->total, 2, ',', '.' ) }}</span>
                            </div>
                            <div class="mb-2">
                                <strong>Desconto:</strong>
                                <span class="text-danger">R$ {{ number_format( $service->discount, 2, ',', '.' ) }}</span>
                            </div>
                            <div class="mb-2">
