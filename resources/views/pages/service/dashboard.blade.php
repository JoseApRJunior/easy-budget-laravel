                  ...
                  <tbody>
                    @foreach( $recent as $service )
                      <tr>
                        ...
                        <td>
                          <span class="badge bg-{{ $service->serviceStatus->color ?? 'secondary' }}">
  ...
  <script>
    document.addEventListener( 'DOMContentLoaded', function () {
      ...
      if ( statusValues.length === 0 ) {
        ...
        if ( chartContainer ) {
          chartContainer.innerHTML = '<p class="text-muted text-center mb-0 small">Nenhum serviço cadastrado</p>';
        }
        return;
      }
