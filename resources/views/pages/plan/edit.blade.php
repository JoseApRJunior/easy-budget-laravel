    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="card shadow-lg border-0 rounded-lg">
                ...
                <form action="{{ route('plans.update', $plan->slug) }}" method="POST" class="needs-validation" novalidate>
                    @csrf
                    @method('PUT')
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror"
                                      ...
                                      name="description"
                                      rows="3"
                                      placeholder="Descreva os benefícios e características do plano">{{ old('description', $plan->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
