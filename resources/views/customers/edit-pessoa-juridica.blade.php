...
@section('title', 'Editar Cliente - Pessoa Jurídica')
...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-1">
                <i class="bi bi-building-gear text-warning me-2"></i>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('provider.customers.show', $customer) }}">{{ $customer->commonData?->company_name }}</a></li>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-transparent">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <span class="badge bg-{{ $customer->status === 'active' ? 'success' : ($customer->status === 'prospect' ? 'warning' : 'secondary') }} me-2">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('provider.customers.update-pessoa-juridica', $customer) }}" id="pessoaJuridicaEditForm" novalidate>
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date"
                                       ...
                                       id="founding_date"
                                       name="founding_date"
                                       value="{{ old('founding_date', $customer->businessData?->founding_date) }}"
                                       max="{{ date('Y-m-d') }}">
                                @error('founding_date')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="email"
                                       ...
                                       id="email_personal"
                                       name="email_personal"
                                       value="{{ old('email_personal', $customer->contact?->email_personal) }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text"
                                       class="form-control @error('phone_personal') is-invalid @enderror"
                                       id="phone_personal"
                                       name="phone_personal"
                                       value="{{ old('phone_personal', $customer->contact?->phone_personal) }}"
                                       placeholder="(00) 00000-0000"
                                       maxlength="15">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text"
                                       ...
                                       id="first_name"
                                       name="first_name"
                                       value="{{ old('first_name', $customer->commonData?->first_name) }}"
                                       maxlength="100">
                                @error('first_name')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text"
                                       ...
                                       id="last_name"
                                       name="last_name"
                                       value="{{ old('last_name', $customer->commonData?->last_name) }}"
                                       maxlength="100">
                                @error('last_name')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select @error('company_size') is-invalid @enderror"
                                    ...
                                    <option value="micro" {{ old('company_size', $customer->businessData?->company_size) == 'micro' ? 'selected' : '' }}>
                                        Micro Empresa
                                    </option>
                                    <option value="pequena" {{ old('company_size', $customer->businessData?->company_size) == 'pequena' ? 'selected' : '' }}>
                                        Pequena Empresa
                                    </option>
                                    <option value="media" {{ old('company_size', $customer->businessData?->company_size) == 'media' ? 'selected' : '' }}>
                                        Média Empresa
                                    </option>
                                    <option value="grande" {{ old('company_size', $customer->businessData?->company_size) == 'grande' ? 'selected' : '' }}>
                                        Grande Empresa
                                    </option>
                                </select>
                                @error('company_size')
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select @error('area_of_activity_id') is-invalid @enderror"
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text"
                                       ...
                                       id="cep"
                                       name="cep"
                                       value="{{ old('cep', $customer->address?->cep) }}"
                            ...
                            <div class="col-md-7">
                                ...
                                <input type="text"
                                       ...
                                       id="address"
                                       name="address"
                                       value="{{ old('address', $customer->address?->address) }}"
                                       required>
                                @error('address')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control @error('notes') is-invalid @enderror"
                                          ...
                                          name="notes"
                                          rows="3"
                                          placeholder="Observações sobre a empresa">{{ old('notes', $customer->businessData?->notes) }}</textarea>
                                @error('notes')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                                ...
                                <div class="d-flex justify-content-between align-items-center pt-4">
                                    ...
                                    <div class="d-flex gap-2">
                                        <button type="submit" class="btn btn-warning" id="submitBtn">
                                            <i class="bi bi-check-circle me-2"></i>Atualizar Empresa
                                        </button>
                                    </div>
                                </div>
                            </div>
...
$(document).ready(function() {
    ...
    validateCNPJ({{ $customer->id }});
    validateEmailBusiness({{ $customer->id }});
    ...
    // Envio do formulário
    $('#pessoaJuridicaEditForm').on('submit', function(e) {
        if (!validateCNPJ({{ $customer->id }}) || !validateEmailBusiness({{ $customer->id }})) {
            e.preventDefault();
            return false;
        }
