{{--
User menu partial - resources/views/layouts/partials/user-menu.blade.php
Convertido de partials/shared/user-menu.twig
--}}
...
<li class="nav-item dropdown">
    @auth
        ...
        <ul class="dropdown-menu dropdown-menu-end shadow-sm" aria-labelledby="userDropdown">
          ...
          <li>
            <a class=" dropdown-item" href="{{ url( '/provider/integrations/mercadopago' ) }}">
          ...
          <li>
            ...
            <li>
                <a class="dropdown-item" href="{{ url( '/support' ) }}">
                    <i class="bi bi-headset me-1" ></i>Suporte </a>
            </li>
            <li>
    ...
    @else
        <a class="nav-link btn btn-primary btn-sm px-3" href="{{ url( '/login' ) }}">
