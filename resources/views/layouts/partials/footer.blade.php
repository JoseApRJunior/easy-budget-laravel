{{--
Footer partial - resources/views/layouts/partials/footer.blade.php
Convertido de partials/shared/footer.twig
--}}
        ...
        <div class="row gy-4">
            <div class="col-md-4">
                <div class="footer-brand mb-3">
                    <img src="{{ asset( 'images/logo.png' ) }}" alt="Easy Budget Logo" class="logo-img me-2" role="img"
