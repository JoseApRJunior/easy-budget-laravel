{{--
Navigation partial - resources/views/layouts/partials/navigation.blade.php
Convertido de partials/shared/navigation.twig
--}}
        ...
        @auth
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="adminDropdown">
                    ...
                    <li><a class="dropdown-item" href="{{ url( '/admin/backups' ) }}"><i
                                class="bi bi-database me-2"></i>Backups</a></li>
                    <li><a class="dropdown-item" href="{{ url( '/admin/logs' ) }}"><i
                                class="bi bi-terminal me-2"></i>Logs</a>
                    </li>
                    <li><a class="dropdown-item" href="{{ url( '/admin/activities' ) }}"><i
                                class="bi bi-activity me-2"></i>Atividades</a></li>
                    <li><a class="dropdown-item" href="{{ url( '/admin/ai' ) }}"><i
                                class="bi bi-robot me-2"></i>Inteligência
                            Artificial</a></li>
                    <li>
                        <hr class="dropdown-divider">
                    </li>
                    ...
                    <li><a class="dropdown-item" href="{{ url( '/admin/users' ) }}"><i
                    ...
                    <li><a class="dropdown-item" href="{{ url( '/admin/tenants' ) }}"><i
        ...
        @if( request()->path() != '/' && auth()->check() )
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="managementDropdown">
                    ...
                    <li><a class="dropdown-item" href="{{ url( '/provider/products' ) }}"><i
