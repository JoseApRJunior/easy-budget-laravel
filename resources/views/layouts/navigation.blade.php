...
<div class="collapse navbar-collapse" id="navbarNav">
  ...
  <ul class="navbar-nav ms-auto">
    ...
    @if(session()->get('auth')->admin ?? false)
    <li class="nav-item dropdown">
      ...
      <ul class="dropdown-menu" aria-labelledby="adminDropdown">
        ...
        <li><a class="dropdown-item" href="/admin/alerts"><i class="bi bi-exclamation-triangle me-2"></i>Alertas</a>
        </li>
        <li>
        ...
        <li><a class="dropdown-item" href="/admin/activities"><i class="bi bi-activity me-2"></i>Atividades</a></li>
        <li><a class="dropdown-item" href="/admin/ai"><i class="bi bi-robot me-2"></i>Inteligência Artificial</a></li>
        ...
        <li><a class="dropdown-item" href="/admin/settings"><i class="bi bi-gear me-2"></i>Configurações</a></li>
      </ul>
    </li>
    @endif
    @endif
    ...
    <li class="nav-item dropdown">
      ...
      <ul class="dropdown-menu" aria-labelledby="managementDropdown">
        <li><a class="dropdown-item" href="/provider/budgets"><i class="bi bi-file-earmark-text me-2"></i>Orçamentos</a>
        </li>
        <li><a class="dropdown-item" href="/provider/services"><i class="bi bi-tools me-2"></i>Serviços</a></li>
        <li><a class="dropdown-item" href="/provider/invoices"><i class="bi bi-receipt me-2"></i>Faturas</a></li>
        <li><a class="dropdown-item" href="/provider/customers"><i class="bi bi-people me-2"></i>Clientes</a></li>
