        ...
        <table style="width: 100%; border-collapse: collapse;">
            <tr>
                <td style="text-align: left;">
                    <span style="font-size: 12px; font-weight: bold; color: {{ $colors['text'] }}; text-transform: uppercase; letter-spacing: 0.5px;">
                        {{ $service->category->name }}
                    </span>
                </td>
                <td style="text-align: right;">
                    <span style="font-size: 8px; font-weight: bold; text-transform: uppercase; letter-spacing: 0.5px; color: {{ $colors['text'] }};">
                ...
                <tr style="border-bottom: 0.5px solid {{ $colors['border'] }};">
                    <td style="padding: 8px 0; vertical-align: top;">
                        ...
                        @if($item->product?->description)
                            <div style="font-size: 8.5px; color: {{ $colors['text'] }}; line-height: 1.3; margin-top: 3px; padding-right: 10px;">
                    ...
                    <td style="text-align: right; padding: 8px 0; vertical-align: top; font-weight: bold; color: {{ $colors['text'] }};">R$ {{ \App\Helpers\CurrencyHelper::format($item->quantity * $item->unit_value) }}</td>
                </tr>
                @endforeach
            </tbody>
            <tfoot>
                <tr>
                    <td colspan="3" style="text-align: right; padding-top: 12px; padding-right: 15px;">
                        <span style="font-size: 8px; color: {{ $colors['text'] }}; text-transform: uppercase; letter-spacing: 1px;">Total do Serviço</span>
                    </td>
                    <td style="text-align: right; padding-top: 12px;">
                        <span style="font-weight: bold; color: {{ $colors['text'] }}; font-size: 12px; border-bottom: 2px solid {{ $colors['primary'] }}; padding-bottom: 2px;">
