<div class="card border-0 shadow-sm h-100">
    ...
    <div class="card-body">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <div>
                <h6 class="mb-0 text-dark">Faturamento Mensal</h6>
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <div>
                <h6 class="mb-0 text-dark">Orçamentos Pendentes</h6>
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <div>
                <h6 class="mb-0 text-dark">Pagamentos Atrasados</h6>
                <small class="text-muted">
        ...
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h6 class="mb-0 text-dark">Projeção Próximo Mês</h6>
    ...
    <div class="card-footer bg-transparent border-top-0 pb-4">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('provider.reports.financial') }}" class="btn btn-sm btn-link text-decoration-none p-0 text-primary">
