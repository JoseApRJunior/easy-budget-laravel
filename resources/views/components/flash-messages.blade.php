...
@foreach ( session( 'success', [] ) as $message )
    <div x-data="alert()" x-show="show" x-transition:enter="transform ease-out duration-300 transition"
        x-transition:enter-start="translate-y-2 opacity-0 sm:translate-y-0 sm:translate-x-2"
        x-transition:enter-end="translate-y-0 opacity-100 sm:translate-x-0"
        x-transition:leave="transition ease-in duration-150" x-transition:leave-start="opacity-100"
        x-transition:leave-end="opacity-0" class="mb-4 {{ $class }}">
        ...
        <div class="alert alert-success flex items-center justify-between">
            ...
            <button @click="dismiss()"
                class="ml-4 text-green-600 hover:text-green-800 focus:outline-none focus:text-green-800">
...
@foreach ( session( 'error', [] ) as $message )
    <div x-data="alert()" x-show="show" x-transition:enter="transform ease-out duration-300 transition"
        ...
        <div class="alert alert-danger flex items-center justify-between">
            ...
            <button @click="dismiss()" class="ml-4 text-red-600 hover:text-red-800 focus:outline-none focus:text-red-800">
                <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                    <path fill-rule="evenodd"
                        d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z"
                        clip-rule="evenodd" />
...
@foreach ( session( 'warning', [] ) as $message )
    <div x-data="alert()" x-show="show" x-transition:enter="transform ease-out duration-300 transition"
        ...
        <div class="alert alert-warning flex items-center justify-between">
            ...
            <button @click="dismiss()"
                class="ml-4 text-yellow-600 hover:text-yellow-800 focus:outline-none focus:text-yellow-800">
                <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                    <path fill-rule="evenodd"
                        d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z"
                        clip-rule="evenodd" />
...
@foreach ( session( 'info', [] ) as $message )
    <div x-data="alert()" x-show="show" x-transition:enter="transform ease-out duration-300 transition"
        ...
        <div class="alert alert-info flex items-center justify-between">
            ...
            <button @click="dismiss()"
                class="ml-4 text-blue-600 hover:text-blue-800 focus:outline-none focus:text-blue-800">
                <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                    <path fill-rule="evenodd"
                        d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z"
                        clip-rule="evenodd" />
        ...
        <div class="alert alert-danger">
            <div class="flex items-center justify-between mb-3">
                <div class="flex items-center">
                    ...
                    <span class="text-red-800 font-medium">Por favor, corrija os seguintes erros:</span>
                </div>
                <button @click="dismiss()" class="text-red-600 hover:text-red-800 focus:outline-none focus:text-red-800">
                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd"
                            d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z"
                            clip-rule="evenodd" />
