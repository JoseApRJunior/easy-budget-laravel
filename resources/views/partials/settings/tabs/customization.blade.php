...
function resetCustomization() {
    if (confirm('Tem certeza que deseja redefinir todas as configurações de personalização para o padrão?')) {
        document.getElementById('theme').value = 'light';
        document.getElementById('primary_color').value = '#0066cc';
        document.getElementById('layout_density').value = 'normal';
        document.getElementById('sidebar_position').value = 'left';
        document.getElementById('animations_enabled').checked = true;
        document.getElementById('sound_enabled').checked = false;
    }
}
</script>
