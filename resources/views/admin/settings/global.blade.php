    ...
    <div class="row mb-4">
        <div class="col-12">
            <ul class="nav nav-pills" id="settingsTabs" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="configuration-tab" data-bs-toggle="pill" data-bs-target="#configuration" type="button">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="entities-tab" data-bs-toggle="pill" data-bs-target="#entities" type="button">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="timezone" name="timezone" required>
                                        <option value="America/Sao_Paulo" {{ ($settings['timezone'] ?? 'America/Sao_Paulo') == 'America/Sao_Paulo' ? 'selected' : '' }}>America/São Paulo</option>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="email" class="form-control" id="support_email" name="support_email" 
                                           value="{{ $settings['support_email'] ?? '' }}" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="currency" name="currency" required>
                                        <option value="BRL" {{ ($settings['currency'] ?? 'BRL') == 'BRL' ? 'selected' : '' }}>BRL - Real Brasileiro</option>
                                        <option value="USD" {{ ($settings['currency'] ?? '') == 'USD' ? 'selected' : '' }}>USD - Dólar Americano</option>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="trial_days" name="trial_days" 
                                           value="{{ $settings['trial_days'] ?? '7' }}" min="1" max="365" required>
                                </div>
                                <div class="mb-3">
                                    <label for="max_tenants_per_user" class="form-label">Máximo de Tenants por Usuário</label>
                                    <input type="number" class="form-control" id="max_tenants_per_user" name="max_tenants_per_user" 
                                           value="{{ $settings['max_tenants_per_user'] ?? '1' }}" min="1" max="100" required>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="session_lifetime" name="session_lifetime" 
                                           value="{{ $settings['session_lifetime'] ?? '120' }}" min="1" max="43200" required>
                                </div>
                            </div>
                        </div>
                        <button type="submit" class="btn btn-primary">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="payment_currency" name="payment_currency" required>
                                        <option value="BRL" {{ ($settings['payment_currency'] ?? 'BRL') == 'BRL' ? 'selected' : '' }}>BRL</option>
                                        <option value="USD" {{ ($settings['payment_currency'] ?? '') == 'USD' ? 'selected' : '' }}>USD</option>
                                        <option value="EUR" {{ ($settings['payment_currency'] ?? '') == 'EUR' ? 'selected' : '' }}>EUR</option>
                                    </select>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="payment_tax_rate" name="payment_tax_rate" 
                                           value="{{ $settings['payment_tax_rate'] ?? '0' }}" min="0" max="100" step="0.01" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="payment_processing_fee" class="form-label">Taxa de Processamento (%)</label>
                                    <input type="number" class="form-control" id="payment_processing_fee" name="payment_processing_fee" 
                                           value="{{ $settings['payment_processing_fee'] ?? '0' }}" min="0" max="100" step="0.01" required>
                                </div>
                                <div class="mb-3">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="enable_recurring_payments" name="enable_recurring_payments" 
                    ...
                    <form action="{{ route('admin.settings.notifications.update') }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    <label for="notification_email_frequency" class="form-label">Frequência de Email</label>
                                    <select class="form-select" id="notification_email_frequency" name="notification_email_frequency" required>
                                        <option value="immediate" {{ ($settings['notification_email_frequency'] ?? 'immediate') == 'immediate' ? 'selected' : '' }}>Imediato</option>
                                        <option value="daily" {{ ($settings['notification_email_frequency'] ?? '') == 'daily' ? 'selected' : '' }}>Diário</option>
                                        <option value="weekly" {{ ($settings['notification_email_frequency'] ?? '') == 'weekly' ? 'selected' : '' }}>Semanal</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="max_emails_per_hour" class="form-label">Máximo de Emails por Hora</label>
                                    <input type="number" class="form-control" id="max_emails_per_hour" name="max_emails_per_hour" 
                                           value="{{ $settings['max_emails_per_hour'] ?? '100' }}" min="1" max="1000" required>
                                </div>
                                <div class="mb-3">
                                    <label for="max_sms_per_hour" class="form-label">Máximo de SMS por Hora</label>
                                    <input type="number" class="form-control" id="max_sms_per_hour" name="max_sms_per_hour" 
                                           value="{{ $settings['max_sms_per_hour'] ?? '10' }}" min="1" max="100" required>
                                </div>
                                <div class="mb-3">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="enable_notification_queue" name="enable_notification_queue" 
                    ...
                    <form action="{{ route('admin.settings.ai.update') }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="enable_ai_analytics" name="enable_ai_analytics" 
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="ai_provider" name="ai_provider" required>
                                        ...
                                        <option value="google" {{ ($settings['ai_provider'] ?? '') == 'google' ? 'selected' : '' }}>Google</option>
                                        <option value="local" {{ ($settings['ai_provider'] ?? '') == 'local' ? 'selected' : '' }}>Local</option>
                                    </select>
                                </div>
                                <div class="mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    <label for="analytics_retention_days" class="form-label">Retenção de Analytics (dias)</label>
                                    <input type="number" class="form-control" id="analytics_retention_days" name="analytics_retention_days" 
                                           value="{{ $settings['analytics_retention_days'] ?? '365' }}" min="30" max="3650" required>
                                </div>
                                <div class="mb-3">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="enable_real_time_analytics" name="enable_real_time_analytics" 
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="enable_predictive_analytics" name="enable_predictive_analytics" 
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="enable_customer_insights" name="enable_customer_insights" 
                                ...
                                <div class="mb-3">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="enable_financial_forecasting" name="enable_financial_forecasting" 
                    ...
                    <form action="{{ route('admin.settings.backup.update') }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    <label for="backup_storage_driver" class="form-label">Driver de Armazenamento</label>
                                    <select class="form-select" id="backup_storage_driver" name="backup_storage_driver" required>
                                        <option value="local" {{ ($settings['backup_storage_driver'] ?? 'local') == 'local' ? 'selected' : '' }}>Local</option>
                                        <option value="s3" {{ ($settings['backup_storage_driver'] ?? '') == 's3' ? 'selected' : '' }}>Amazon S3</option>
                                        <option value="ftp" {{ ($settings['backup_storage_driver'] ?? '') == 'ftp' ? 'selected' : '' }}>FTP</option>
                                        <option value="dropbox" {{ ($settings['backup_storage_driver'] ?? '') == 'dropbox' ? 'selected' : '' }}>Dropbox</option>
                                    </select>
                                </div>
                                <div class="mb-3">
                                    <div class="form-check form-switch">
