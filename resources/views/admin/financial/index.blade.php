        ...
        <x-layout.page-header
            ...
            <x-slot:actions>
                <div class="d-flex gap-2">
                    <x-ui.button type="button" variant="secondary" outline icon="download" label="Exportar" onclick="exportReports()" feature="manage-tenants" />
                    <x-ui.button type="button" variant="secondary" outline icon="bell" label="Alertas" onclick="refreshBudgetAlerts()" feature="manage-tenants" />
                    <x-ui.button :href="route('admin.enterprises.index')" variant="primary" icon="building" label="Ver Empresas" feature="manage-tenants" />
                </div>
            </x-slot:actions>
        </x-layout.page-header>
                ...
                <div class="row mt-3 g-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <x-ui.button type="link" :href="route('admin.financial.index')" variant="secondary" icon="x-lg" label="Limpar" feature="manage-tenants" />
                        </div>
                    </div>
                </div>
            </form>
        ...
        <x-ui.card>
            <x-slot:header>
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex gap-2">
                        <x-ui.button type="link" :href="route('admin.financial.reports')" variant="primary" size="sm" icon="chart-bar" label="Relatórios Detalhados" feature="manage-tenants" />
                    </div>
                </div>
            </x-slot:header>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex gap-1">
                                            <x-ui.button type="link" :href="'/admin/financial/providers/' . $provider['id'] . '/details'" variant="primary" size="sm" icon="chart-line" title="Ver Detalhes" feature="manage-tenants" />
                                            <x-ui.button type="link" :href="route('admin.enterprises.show', $provider['id'])" variant="info" size="sm" icon="building" title="Ver Empresa" feature="manage-tenants" />
                                        </div>
                                    </td>
                                </tr>
                            @endforeach
                    ...
                    @foreach ($providersData as $provider)
                        <x-ui.card class="mb-3">
                            ...
                            <div class="d-flex gap-2 mt-3">
                                <x-ui.button type="link" :href="'/admin/financial/providers/' . $provider['id'] . '/details'" variant="primary" size="sm" icon="chart-line" label="Detalhes" class="flex-grow-1" feature="manage-tenants" />
                                <x-ui.button type="link" :href="route('admin.enterprises.show', $provider['id'])" variant="info" size="sm" icon="building" label="Empresa" class="flex-grow-1" feature="manage-tenants" />
                            </div>
                        </x-ui.card>
                    @endforeach
                </div>
            @else
                ...
                <div class="text-center py-5">
                    ...
                    <x-ui.button type="link" :href="route('admin.enterprises.index')" variant="primary" icon="building" label="Ver Empresas" feature="manage-tenants" />
                </div>
            @endif
        </x-ui.card>
    </x-layout.page-container>
