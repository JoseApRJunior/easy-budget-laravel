            ...
            <div class="card shadow">
                ...
                <div class="card-body">
                    <form method="GET" action="{{ route('admin.financial.reports') }}" class="form-inline">
                        ...
                        <x-ui.button type="submit" variant="primary" label="Filtrar" icon="filter" class="mr-2" feature="manage-tenants" />
                        <x-ui.button type="link" :href="route('admin.financial.reports')" variant="secondary" label="Limpar" icon="times" feature="manage-tenants" />
                    </form>
                </div>
            </div>
        </div>
            ...
            <div class="card shadow">
                <div class="card-footer bg-white border-top-0">
                    <div class="d-flex flex-wrap gap-2">
                        <x-ui.button variant="success" label="Exportar Relatório" icon="download" class="flex-grow-1" onclick="exportReports()" feature="manage-tenants" />
                        <x-ui.button variant="info" label="Imprimir" icon="printer" class="flex-grow-1" onclick="printReports()" feature="manage-tenants" />
                        <x-ui.back-button index-route="admin.financial.index" class="flex-grow-1" label="Voltar" />
                        <x-ui.button variant="warning" label="Atualizar" icon="arrow-clockwise" class="flex-grow-1" onclick="refreshData()" feature="manage-tenants" />
                    </div>
                </div>
            </div>
        </div>
