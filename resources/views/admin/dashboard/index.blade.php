                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ number_format($systemMetrics['total_tenants']) }}</div>
                        </div>
                        <div class="col-auto">
                    ...
                    <div class="mt-2">
                        <small class="text-success">
                            <i class="bi bi-arrow-up"></i> {{ $systemMetrics['new_tenants_period'] }} novos neste período
                        </small>
                    </div>
                </div>
            </div>
            ...
            <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                    ...
                    <div class="mt-2">
                        ...
                        <small class="text-success">
                            <i class="bi bi-arrow-up"></i> +{{ number_format($financialMetrics['revenue_growth'], 1) }}%
                        </small>
                        @else
                        <small class="text-danger">
                            <i class="bi bi-arrow-down"></i> {{ number_format($financialMetrics['revenue_growth'], 1) }}%
                        </small>
                        @endif
                        vs período anterior
                    </div>
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ number_format($userMetrics['total_customers']) }}</div>
                        </div>
                        <div class="col-auto">
                    ...
                    <div class="mt-2">
                        <small class="text-info">
                            <i class="bi bi-arrow-up"></i> {{ $userMetrics['new_customers_period'] }} novos neste período
                        </small>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ number_format($userMetrics['total_providers']) }}</div>
                        </div>
                        <div class="col-auto">
        ...
        <div class="col-xl-4 col-lg-5">
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    ...
                    <div class="dropdown no-arrow">
                        <a class="dropdown-toggle" href="#" role="button" id="planDropdown" data-bs-toggle="dropdown">
                            <i class="bi bi-three-dots-vertical fs-6 text-gray-400"></i>
                        </a>
                        <div class="dropdown-menu dropdown-menu-end shadow animated--fade-in">
                ...
                <div class="card-body">
                    ...
                    <div class="mt-4 text-center small">
                        ...
                        <span class="me-2">
                            <i class="bi bi-circle-fill" style="color: {{ $loop->index == 0 ? '#4e73df' : ($loop->index == 1 ? '#1cc88a' : ($loop->index == 2 ? '#36b9cc' : '#f6c23e')) }}"></i>
